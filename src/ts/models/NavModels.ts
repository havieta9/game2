...
export class TodoRootNavContext extends CompositeRootNavContext {
    ...
    constructor(selectedTodoId?: string, public showNewTodoPanel = false,public showHome=false,public showTokenomics=false,public showRoadMap=false,public showWhitePaper=false) {
        super(NavViewId.TodoComposite);
        this.todoList = new TodoListViewNavContext(selectedTodoId);
    }

    clone(): TodoRootNavContext {
        return new TodoRootNavContext(this.todoList.selectedTodoId, this.showNewTodoPanel,this.showHome,this.showTokenomics,this.showRoadMap,this.showWhitePaper);
    }
}
...
export class TokenomicsViewNavContext extends ViewNavContext {
    constructor() {
        super(NavViewId.Tokenomics);
    }

    clone(): TokenomicsViewNavContext {
        return new TokenomicsViewNavContext();
    }
}
export class RoadMapViewNavContext extends ViewNavContext {
    constructor() {
        super(NavViewId.RoadMap);
    }
...
export class WhitePaperViewNavContext extends ViewNavContext {
    constructor() {
        super(NavViewId.WhitePaper);
    }

    clone(): WhitePaperViewNavContext {
        return new WhitePaperViewNavContext();
    }
}