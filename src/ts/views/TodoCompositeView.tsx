...
export default class TodoCompositeView extends ComponentBase<TodoCompositeViewProps, TodoCompositeViewState> {
    ...
    render(): JSX.Element | null {
        return (
            <RX.View style={_styles.viewContainer}>
                {!this.state.isLogin ? null : <RX.View style={_styles.leftPanelContainer}>
                    <TodoListPanel
    ...
    private _renderRightPanel() {
        ...
        } else if (this.props.navContext.showHome) {
            return (
                <HomePanel />
            );
        } else if (this.props.navContext.showTokenomics) {
            return (
                <Tokenomics />
            );
        } else if (this.props.navContext.showRoadMap) {
            return (
                <RoadMap />
            );
        } else if (this.props.navContext.showWhitePaper) {
            return (
                <WhitePaper />
            );
        } else {
