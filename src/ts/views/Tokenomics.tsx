...
export default class Tokenomics extends RX.Component<CreateTodoPanelProps, CreateTodoPanelState> {
    render() {
        return (
            <RX.View useSafeInsets={true} style={[_styles.container, Styles.statusBarTopMargin, {}]}>
                ...
                <UI.Paper elevation={10} style={{ root: { borderRadius: 18, margin: 50, flex: 80, backgroundColor: 'gray', alignSelf: 'stretch' } }} >
                    <RX.Image resizeMethod={'resize'} resizeMode={'contain'} style={{ flex: 1, alignSelf: 'stretch', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }} source={ImageSource.tokenomics} />
