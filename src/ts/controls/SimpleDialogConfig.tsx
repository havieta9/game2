...
export default class SimpleDialogConfig extends ComponentBase<SimpleDialogProps, RX.Stateless> {
    componentDidMount() {
    ...
    private _renderButton = (buttonDef: SimpleDialogButton, index: number): JSX.Element => (
        <SimpleButton
            ...
            buttonStyle={{borderWidth:0,marginTop:20,marginRight:10,marginLeft:10,borderRadius:11.48,backgroundColor:'#343261',width:190,height:47,justifyContent:'center',alignItems:'center'}}
            textStyle={_styles.text3}
        />
    );
