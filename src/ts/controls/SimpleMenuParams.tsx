...
const _styles = {
    menuContainer: RX.Styles.createScrollViewStyle({
        backgroundColor: '#221F4B',
        width:440,
    
        maxHeight:RX.UserInterface.measureWindow().height*0.8
    }),
     menuContainer2: RX.Styles.createViewStyle({
        backgroundColor: '#221F4B',
        width:440,
...
export default class SimpleMenuParams extends ComponentBase<MenuProps, MenuState> {
    ...
    render() {
        ...
        return (
            <RX.View style={_styles.menuContainer2}>
            <RX.ScrollView style={ _styles.menuContainer } onKeyPress={ this._onKeyPress }>
              { menuItems }
          
            </RX.ScrollView>   </RX.View>
        );
    }
